...
After brewing kombucha for about two years with a few brews under my belt, I realized I needed a simple way to keep track of my brewing schedule. I'm not a fan of overcomplicating things, and initially, I just tried to remember when I started each brew. When I began brewing multiple brews, I used a repeating calendar event to stay organized. But as my brewing became more frequent, this system started to fall out of sync, especially when life got in the way, and I started a brew a day later than planned.

So, I created a super simple app, Kombu Time, to keep track of my brewing process. It's free, open-source, and designed to do just one thing: track when you start your brews and notify you when it's time to start or end the second fermentation. No complicated features like ingredients, notes, ratings, or history—just what's needed to make brewing easier. Once you set it up (like deciding how many days you want for fermentation), starting a new brew is as easy as tapping a button.
